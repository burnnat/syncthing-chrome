...
import { ActionType, SyncthingAction, FetchCertAction, ConnectAction } from 'common/action-type';
...
const handleFetchCert = (action: FetchCertAction) => {
...
const handleConnect = (action: ConnectAction) => {
	return (dispatch: Dispatch<State>) => {
